...
const DocumentNode = memo(({ id, data, selected, style: rfStyle }) => {
  ...
  return (
    ...
    >
      ...
      <Handle type="target" position={Position.Top}    id="top-t"    style={{ background: '#2dd4bf', width: 8, height: 8, border: '2px solid #0f172a', top: -4, left: '50%', transform: 'translateX(-50%)' }} />
      <Handle type="source" position={Position.Top}    id="top-s"    style={{ background: '#2dd4bf', width: 8, height: 8, border: '2px solid #0f172a', top: -4, left: '50%', transform: 'translateX(-50%)' }} />
      <Handle type="target" position={Position.Left}   id="left-t"   style={{ background: '#2dd4bf', width: 8, height: 8, border: '2px solid #0f172a', left: -4, top: '40%', transform: 'translateY(-50%)' }} />
      <Handle type="source" position={Position.Left}   id="left-s"   style={{ background: '#2dd4bf', width: 8, height: 8, border: '2px solid #0f172a', left: -4, top: '40%', transform: 'translateY(-50%)' }} />
      ...
      <Handle type="target" position={Position.Bottom} id="bottom-t" style={{ background: '#2dd4bf', width: 8, height: 8, border: '2px solid #0f172a', bottom: -4, left: '50%', transform: 'translateX(-50%)' }} />
      <Handle type="source" position={Position.Bottom} id="bottom-s" style={{ background: '#2dd4bf', width: 8, height: 8, border: '2px solid #0f172a', bottom: -4, left: '50%', transform: 'translateX(-50%)' }} />
      <Handle type="target" position={Position.Right}  id="right-t"  style={{ background: '#2dd4bf', width: 8, height: 8, border: '2px solid #0f172a', right: -4, top: '40%', transform: 'translateY(-50%)' }} />
      <Handle type="source" position={Position.Right}  id="right-s"  style={{ background: '#2dd4bf', width: 8, height: 8, border: '2px solid #0f172a', right: -4, top: '40%', transform: 'translateY(-50%)' }} />
    </div>
  );
});
